...
public class NsMessageConstant {

    /**
     * Check on moving the messages to a property file and then load from there at
     * the runtime.
     * 
     */
    ...
    public static final String CONFIG_UPDATE_SUCCESS = "Configuration updated successfully";
    public static final String CONFIG_UPDATE_ERROR = "Error occured while updaing the configuration";

    public static final String PICTURE_DELETE_SUCCESS = "Picture deleted successfully";
